...
f1 = client.moveToPositionAsync(0, -10, -6, 5, vehicle_name="Drone1")
f2 = client.moveToPositionAsync(0, 7, -6, 5, vehicle_name="Drone2")
f3 = client.moveToPositionAsync(10, 7, -6, 5, vehicle_name="Drone3")
f4 = client.moveToPositionAsync(10, -10, -6, 5, vehicle_name="Drone4")
...
dgoal = np.array([ [10,10,0,0], [7,-10,-10,7] , [-6,-6,-6,-6] ])
...
def create_single_integrator_barrier_certificate(barrier_gain=.1, safety_radius=4, magnitude_limit=.5):
    ...
    def f(dxi, x):
        ...
        b[num_constraints+1] = -3

        A[num_constraints+2] = [0,0,0,0,0,zVec2,0,0,0,0,0,0]
