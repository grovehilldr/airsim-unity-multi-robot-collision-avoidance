...
f1 = client.moveToPositionAsync(0, 0, -10, 2, vehicle_name="Drone1")
f2 = client.moveToPositionAsync(7, 0, -10, 2, vehicle_name="Drone2")
f3 = client.moveToPositionAsync(0, 7, -10, 2, vehicle_name="Drone3")
f4 = client.moveToPositionAsync(7, 7, -10, 2, vehicle_name="Drone4")
f1.join()
f2.join()
f3.join()
f4.join()
...
x = np.array([[d1x,d2x,d3x,d4x],[d1y,d2y,d3y,d4y]])
N = dxi.shape[1]

dgoal = np.array([ [7,0,7,0], [7,7,0,0] ])
...
#    client.moveToPositionAsync(dxi[0][1], dxi[1][1], dxi[2][1], 4, vehicle_name="Drone2")
    ...
    client.moveByVelocityAsync(dxi[0][0], dxi[1][0], dd1z, 0.3, vehicle_name="Drone1")
    client.moveByVelocityAsync(dxi[0][1], dxi[1][1], dd2z, 0.3, vehicle_name="Drone2")
    client.moveByVelocityAsync(dxi[0][2], dxi[1][2], dd3z, 0.3, vehicle_name="Drone3")
    client.moveByVelocityAsync(dxi[0][3], dxi[1][3], dd4z, 0.3, vehicle_name="Drone4")
